...
assert.deepEqual(
  resolveTransactionGroupUpdateTemporalFields(posted, {
...
assert.deepEqual(
  resolveTransactionGroupUpdateTemporalFields(posted, { date: "2034-03-27" }),
  {
    occurredOn: "2034-01-10",
    plannedOn: "2034-02-15",
...
assert.deepEqual(
  resolveTransactionGroupUpdateTemporalFields(planned, { date: "2034-02-23" }),
  {
    occurredOn: "2034-01-11",
...
assert.deepEqual(
  resolveTransactionGroupCloneTemporalFields(posted, { date: "2035-04-05" }),
  {
