...
export const solverFinDesignSystemExamples = [
  {
    ...
    notes: ["Use texto direto sobre a acao.", "Durante envio, mantenha largura estavel e exponha estado ocupado."],
  },
  {
  ...
  <span>Crie categorias para organizar receitas e despesas.</span>
    ...
    notes: ["Explique o que a pessoa pode fazer em seguida.", "Nao use exemplos com dados financeiros reais."],
  },
  {
  ...
  <table class="sf-table">
    ...
    notes: ["Use tabela apenas para dados tabulares.", "Mantenha scroll horizontal controlado em mobile."],
  },
  {
    name: "Toast feedback",
    ...
    notes: ["Use linguagem curta.", "Erros bloqueantes devem ficar junto ao formulario quando possivel."],
  },
