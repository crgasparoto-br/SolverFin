/**
 * SVG icon helpers for the SolverFin UI.
 *
 * All icons are inline SVGs based on Lucide icon designs (MIT license).
 * Each function returns an SVG string ready to be embedded in HTML.
 * Icons are 16×16 by default and inherit `currentColor` for easy theming.
 *
 * Usage:
 *   import { icon } from "./icons.js";
 *   `<button title="Editar conta">${icon("pencil")} Editar</button>`
 */
...
const svgPaths: Record<IconName, string> = {
  "layout-dashboard":
    '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>',
  receipt:
    '<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1z"/><path d="M16 8H8"/><path d="M16 12H8"/><path d="M12 16H8"/>',
  ...
  tag: '<path d="M12 2H2v10l9.29 9.29a1 1 0 0 0 1.41 0l7.29-7.29a1 1 0 0 0 0-1.41z"/><path d="M7 7h.01"/>',
 ...
 * @param name - Icon identifier from the IconName type
...
/**
 * Returns an icon wrapped in a <span> with aria-hidden for use inside buttons.
 */
export function btnIcon(name: IconName, size = 15): string {
