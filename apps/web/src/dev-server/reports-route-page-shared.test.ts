...
describe("reports view navigation", () => {
  it(
    "keeps the active category view on the current URL so account filters are not discarded",
    () => {
  ...
  it(
    "keeps the active installments view on the current URL while preserving profile on view changes",
    () => {
