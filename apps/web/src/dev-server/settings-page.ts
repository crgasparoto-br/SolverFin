...
function baseCss(): string {
  return `
    ...
    main { display: grid; gap: 20px; margin: 0 auto; max-width: 1440px; padding: 24px; width: 100%; } .page-heading { align-items: start; display: grid; max-width: 760px; gap: 6px; }
    ...
    @media (max-width: 760px) { .inline-edit-form { grid-template-columns: 1fr; } .maintenance-summary, .section-heading { align-items: stretch; display: grid; } }
  `;
}
