...
function css(): string {
  return `
    ...
    .statement-row { align-items: center; border-bottom: 1px solid var(--line); display: grid; gap: 8px; grid-template-columns: 6rem minmax(8rem,1.3fr) minmax(7rem,0.9fr) 7rem 4.5rem 8rem 8rem 3rem; padding: 8px 12px; position: relative; }
    .col-select { display: grid; left: 3px; place-items: center; position: absolute; }
    .statement-body .col-date { padding-left: 14px; }
