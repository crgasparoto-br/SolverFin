...
- Privacidade/provider: Feito; calculos ocorrem antes do provider, consentimento e tenant/perfil sao revalidados, prompt e resposta bruta externa nao sao persistidos e a projecao publica omite IDs internos, evidência privada e chave de idempotencia.
