# [EPIC] Dominio financeiro e persistencia
...
## Escopo
Abrange contas, cartoes, categorias, lancamentos, recorrencias, faturas, orcamentos, anexos, importacoes, sugestoes e auditoria.
...
- [ ] `F01` Modelar entidades financeiras principais
- [ ] `F02` Implementar schema Prisma e migrations iniciais
- [ ] `F03` Criar seed de categorias e dados de exemplo seguros
- [ ] `F04` Implementar auditoria de alteracoes financeiras

## Artefatos esperados
- Codigo, testes e documentacao relacionados ao escopo desta issue.

## Criterios de aceite
- [ ] Modelo suporta lancamentos manuais e sugeridos pela IA sem perda de rastreabilidade.
