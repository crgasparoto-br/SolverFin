# [EPIC] Importacao, automacao e conciliacao
...
## Escopo
Abrange CSV/OFX, mensagens bancarias, regras, fila de revisao e conciliacao.
...
- [ ] `I01` Implementar importacao CSV e OFX inicial
- [ ] `I02` Implementar inbox de mensagens bancarias coladas ou compartilhadas
- [ ] `I03` Implementar motor de deduplicacao de transacoes
- [ ] `I04` Implementar conciliacao entre previsto, importado e realizado
- [ ] `I05` Implementar regras automaticas configuraveis
- [ ] `I06` Criar estudo tecnico de Open Finance via parceiro

## Artefatos esperados
- Codigo, testes e documentacao relacionados ao escopo desta issue.

## Criterios de aceite
- [ ] Sistema sugere lancamentos importados sem duplicar transacoes existentes.
