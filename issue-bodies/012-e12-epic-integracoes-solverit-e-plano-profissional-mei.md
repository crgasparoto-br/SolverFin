# [EPIC] Integracoes SolverIT e plano profissional/MEI
...
## Escopo
Abrange contratos de integracao, eventos, APIs internas e relatorios profissionais.
...
- [ ] `G01` Definir contrato de integracao com Agenda Profissional
- [ ] `G02` Definir contrato de integracao com Limite MEI
- [ ] `G03` Implementar exportacao para contador e relatorios MEI

## Artefatos esperados
- Codigo, testes e documentacao relacionados ao escopo desta issue.

## Criterios de aceite
- [ ] Receitas profissionais podem alimentar controle de limite MEI e relatorios financeiros.
