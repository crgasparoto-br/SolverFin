# Criar README principal orientado a produto e IA
...
## Objetivo
Criar README que explique o que e o SolverFin, como rodar, como testar e como contribuir com agentes de IA.

## Escopo
Adicionar visao do produto, stack escolhida, instalacao, comandos, variaveis, arquitetura resumida e workflow de PR.
...
## Criterios de aceite
- [ ] README permite iniciar o projeto do zero em ambiente local.
- [ ] README possui secao especifica para agentes de IA.
