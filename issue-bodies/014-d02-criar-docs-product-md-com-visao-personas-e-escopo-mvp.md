# Criar docs/PRODUCT.md com visao, personas e escopo MVP
...
## Objetivo
Documentar a visao de produto para evitar que agentes implementem funcionalidades desalinhadas.

## Escopo
Definir proposta de valor, personas, jornadas, escopo MVP, fora de escopo, planos comerciais e prioridades.
...
## Criterios de aceite
- [ ] Documento descreve claramente usuario pessoal, MEI, autonomo e pequeno negocio.
- [ ] MVP e fases futuras estao separados.
