# Criar docs/ARCHITECTURE.md e decisao inicial de stack

**Parent epic:** `E01` - [EPIC] Fundacao documental e operacao por IA
**Fase:** MVP
...
## Objetivo
Definir arquitetura inicial para orientar implementacoes por IA.

## Escopo
Recomendar monorepo TypeScript, frontend web/PWA, backend API, PostgreSQL, Prisma, testes, CI e camadas de dominio; registrar alternativas se necessario.
...
## Criterios de aceite
- [ ] Arquitetura descreve camadas, responsabilidades e limites.
- [ ] Inclui diagrama textual de componentes e fluxo de dados.
