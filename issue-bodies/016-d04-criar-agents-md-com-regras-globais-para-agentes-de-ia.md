# Criar AGENTS.md com regras globais para agentes de IA
...
## Objetivo
Criar instrucoes independentes de ferramenta para agentes como Codex, Copilot, Claude, Cursor e Gemini.

## Escopo
Incluir contexto, comandos, proibicoes, padroes de PR, testes obrigatorios, seguranca e checklist antes de finalizar.
...
## Criterios de aceite
- [ ] AGENTS.md e claro, objetivo e aplicavel por qualquer agente.
- [ ] Inclui politica de nao alterar escopo fora da issue.
