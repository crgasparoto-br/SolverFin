...
## Objetivo
Criar instrucoes especificas para GitHub Copilot e agentes no GitHub.

## Escopo
Incluir resumo do repo, como buildar/testar, padroes de codigo, areas de cuidado, privacidade e referencias de documentos.
...
- [ ] Instrucoes nao conflitam com AGENTS.md.
