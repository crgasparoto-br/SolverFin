# Inicializar monorepo e estrutura de pastas
...
## Objetivo
Criar estrutura inicial para frontend, backend, packages compartilhados e docs.

## Escopo
Estruturar apps/web, apps/api, packages/domain, packages/shared, prisma, docs e scripts.
...
- [ ] Scripts raiz conseguem instalar e validar pacotes.
