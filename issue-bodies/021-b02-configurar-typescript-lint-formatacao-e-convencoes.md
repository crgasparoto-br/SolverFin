# Configurar TypeScript, lint, formatacao e convencoes

**Parent epic:** `E02` - [EPIC] Bootstrap tecnico do repositorio
**Fase:** MVP
...
## Objetivo
Configurar padroes de qualidade para evitar PRs inconsistentes gerados por IA.

## Escopo
Adicionar tsconfig compartilhado, ESLint, Prettier ou Biome, scripts de check e regras de importacao.
...
## Criterios de aceite
- [ ] Comando de lint roda no monorepo.
- [ ] Comando de typecheck roda no monorepo.
