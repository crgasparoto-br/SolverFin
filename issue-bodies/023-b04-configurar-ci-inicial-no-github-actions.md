# Configurar CI inicial no GitHub Actions
...
## Objetivo
Bloquear regressao automatica em PRs de IA.

## Escopo
Workflow deve instalar dependencias, validar lint, typecheck, testes e build.
...
## Criterios de aceite
- [ ] CI roda em pull_request e push para main.
- [ ] Falhas indicam claramente o comando que quebrou.
