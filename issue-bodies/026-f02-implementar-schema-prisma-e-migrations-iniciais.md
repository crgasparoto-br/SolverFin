# Implementar schema Prisma e migrations iniciais
...
## Objetivo
Criar persistencia relacional do dominio financeiro.

## Escopo
Implementar Prisma schema, migrations e indices para tenant, datas, categorias, conta e importacoes.
...
- [ ] Indices cobrem consultas de dashboard e listagens.
