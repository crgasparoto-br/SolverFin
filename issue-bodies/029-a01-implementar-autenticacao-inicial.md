# Implementar autenticacao inicial
...
## Objetivo
Permitir acesso seguro de usuarios ao SolverFin.

## Escopo
Escolher e implementar estrategia de autenticacao compat compativel com arquitetura definida.
