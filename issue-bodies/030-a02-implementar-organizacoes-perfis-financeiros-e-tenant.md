# Implementar organizacoes, perfis financeiros e tenant

**Parent epic:** `E04` - [EPIC] Identidade, acesso e multi-tenant
**Fase:** MVP
...
## Objetivo
Permitir separar contexto pessoal, familia, MEI e negocio.

## Escopo
Criar modelo e APIs para organizacao/perfil financeiro, com tenant obrigatorio em dados financeiros.
...
## Criterios de aceite
- [ ] Usuario pode criar ao menos um perfil financeiro.
- [ ] Toda entidade financeira pertence a um tenant/perfil.
