# Implementar API de contas financeiras
...
## Objetivo
Permitir cadastro e manutencao de contas financeiras.

## Escopo
CRUD de conta corrente, carteira, investimento e conta profissional, com saldo inicial e status.
...
## Criterios de aceite
- [ ] APIs documentadas.
- [ ] Listagem filtra por tenant e status.
