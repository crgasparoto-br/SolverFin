# Implementar API de lancamentos financeiros
...
## Objetivo
Criar o fluxo central de receitas, despesas e transferencias.

## Escopo
CRUD de lancamentos com data, valor, categoria, conta, descricao, fonte, status e anexos futuros.
...
## Criterios de aceite
- [ ] Valida valor positivo e tipo.
- [ ] Transferencia gera movimentos coerentes entre contas.
