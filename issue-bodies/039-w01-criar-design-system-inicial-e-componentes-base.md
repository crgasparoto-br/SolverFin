# Criar design system inicial e componentes base
...
## Objetivo
Padronizar UI para acelerar implementacao por IA.

## Escopo
Criar componentes Button, Input, Select, Dialog, Table, Card, EmptyState, Loading, Toast e form patterns.
...
## Criterios de aceite
- [ ] Componentes possuem exemplos de uso.
