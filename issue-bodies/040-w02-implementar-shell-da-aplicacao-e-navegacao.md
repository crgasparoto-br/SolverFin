# Implementar shell da aplicacao e navegacao
...
## Objetivo
Criar base de navegacao web/PWA.

## Escopo
Layout responsivo, menu lateral/inferior mobile, rotas protegidas e estados de carregamento.
