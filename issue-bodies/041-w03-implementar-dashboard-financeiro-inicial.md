# Implementar dashboard financeiro inicial

**Parent epic:** `E06` - [EPIC] Frontend web/PWA MVP
**Fase:** MVP
...
## Objetivo
Mostrar visao rapida da saude financeira.

## Escopo
Cards de saldo, receitas, despesas, contas proximas, gastos por categoria e fluxo mensal.
...
## Criterios de aceite
- [ ] Dashboard trata vazio, loading e erro.
- [ ] Dados vem das APIs reais ou mocks claramente isolados.
