# Implementar telas de lancamentos e filtros
...
## Objetivo
Permitir uso diario do controle financeiro.

## Escopo
Listagem, criacao, edicao, exclusao logica, filtros por periodo, conta, tipo e categoria.
...
## Criterios de aceite
- [ ] Usuario consegue registrar receita/despesa em menos de uma tela principal.
