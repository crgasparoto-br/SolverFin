# Implementar importacao CSV e OFX inicial
...
## Objetivo
Permitir importar extratos sem integracao bancaria direta no MVP.

## Escopo
Upload, parse, pre-visualizacao, mapeamento de colunas, validacao e importacao como sugestoes.
...
## Criterios de aceite
- [ ] Usuario revisa antes de confirmar importacao.
- [ ] Importacao salva origem e hash para deduplicacao.
