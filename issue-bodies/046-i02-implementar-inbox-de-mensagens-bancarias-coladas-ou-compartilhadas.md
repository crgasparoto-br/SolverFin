# Implementar inbox de mensagens bancarias coladas ou compartilhadas

**Parent epic:** `E07` - [EPIC] Importacao, automacao e conciliacao
**Fase:** MVP
...
## Objetivo
Criar entrada manual/semi-automatica para mensagens de bancos e cartoes.

## Escopo
Endpoint e tela para colar texto, compartilhar mensagem e salvar origem bruta para processamento.
...
## Criterios de aceite
- [ ] Mensagem bruta fica vinculada a sugestao de lancamento.
- [ ] Dados sensiveis sao mascarados na UI quando adequado.
