# Implementar motor de deduplicacao de transacoes
...
## Objetivo
Evitar lancamentos duplicados vindos de multiplas fontes.

## Escopo
Comparar valor, data, descricao, conta/cartao, merchant, importacao e similaridade.
...
## Criterios de aceite
- [ ] Possiveis duplicidades sao marcadas para revisao.
- [ ] Sistema nunca exclui automaticamente sem regra segura.
