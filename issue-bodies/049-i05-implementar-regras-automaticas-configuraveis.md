# Implementar regras automaticas configuraveis
...
## Objetivo
Permitir automacoes deterministicas antes de chamar IA.

## Escopo
Regras por descricao/merchant/valor/conta para categoria, contexto, tag e status.
...
## Criterios de aceite
- [ ] Regra explica porque foi aplicada.
- [ ] Usuario pode ativar/desativar regra.
