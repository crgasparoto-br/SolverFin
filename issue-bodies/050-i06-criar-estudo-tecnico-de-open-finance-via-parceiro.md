# Criar estudo tecnico de Open Finance via parceiro
...
## Objetivo
Avaliar caminho regulatorio e tecnico para Open Finance sem comprometer MVP.

## Escopo
Documentar alternativas de agregadores, consentimento, riscos, custos, renovacao e arquitetura.

## Fora de escopo
Nao cobrir funcionalidades fora do escopo descrito; nao antecipar integracoes externas sem ADR aprovada.

## Artefatos esperados
- `docs/integrations/open-finance.md`

## Criterios de aceite
- [ ] Documento recomenda caminho inicial e criterios para adocao.
