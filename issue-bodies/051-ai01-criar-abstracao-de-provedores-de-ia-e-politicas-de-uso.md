# Criar abstracao de provedores de IA e politicas de uso
...
## Objetivo
Permitir trocar provedor/modelo sem acoplar dominio financeiro.

## Escopo
Interface para extracao, classificacao, resumo e assistente, com timeouts, retries e logs seguros.
...
## Criterios de aceite
- [ ] Nenhuma chamada de IA recebe dados alem do necessario.
