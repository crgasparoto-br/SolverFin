# Definir schemas estruturados para extracao de lancamentos
...
## Objetivo
Garantir respostas parseaveis e auditaveis da IA.

## Escopo
Criar schema de extracao com valor, data, tipo, merchant, conta/cartao, categoria sugerida, confianca e motivos.
...
## Criterios de aceite
- [ ] Saida invalida e rejeitada e enviada para revisao.
- [ ] Campos possuem normalizacao de moeda/data.
