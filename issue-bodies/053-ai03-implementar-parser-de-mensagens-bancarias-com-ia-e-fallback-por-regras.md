# Implementar parser de mensagens bancarias com IA e fallback por regras

**Parent epic:** `E08` - [EPIC] IA financeira aplicada
**Fase:** MVP
...
## Objetivo
Transformar textos de notificacoes/SMS/e-mail em sugestoes de lancamento.

## Escopo
Pipeline: normalizar texto, remover ruido, extrair campos, categorizar, calcular confianca e salvar sugestao.
...
## Criterios de aceite
- [ ] Exemplos de bancos diferentes possuem testes fixture.
- [ ] Fallback por regex cobre casos simples.
