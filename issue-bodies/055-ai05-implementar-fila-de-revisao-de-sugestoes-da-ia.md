# Implementar fila de revisao de sugestoes da IA
...
## Objetivo
Dar controle ao usuario antes da automacao total.

## Escopo
Tela/API para aprovar, rejeitar, ajustar e converter sugestao em lancamento.
...
## Criterios de aceite
- [ ] Toda sugestao exibe origem, confianca e explicacao.
- [ ] Aprovacao cria lancamento auditado.
