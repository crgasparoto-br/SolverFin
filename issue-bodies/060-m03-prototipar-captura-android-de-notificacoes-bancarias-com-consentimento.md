# Prototipar captura Android de notificacoes bancarias com consentimento
...
## Objetivo
Avaliar diferencial de captura automatica de notificacoes no Android.

## Escopo
Criar spike/prototipo separado com Notification Listener, whitelist de apps, consentimento granular e processamento minimo.

## Fora de escopo
Nao publicar app com permissao sensivel antes de revisao de privacidade e loja.

## Artefatos esperados
- Codigo, testes e documentacao relacionados ao escopo desta issue.

## Criterios de aceite
- [ ] Documento de viabilidade cobre riscos, permissoes, UX e privacidade.
- [ ] Prototipo nao captura apps fora da whitelist.
