# Implementar modelo de consentimento e preferencias de privacidade

**Parent epic:** `E10` - [EPIC] Seguranca, LGPD e privacidade financeira
**Fase:** MVP
...
## Objetivo
Registrar consentimentos para importacoes, IA e processamento de mensagens.

## Escopo
Entidades/API/UI para consentimento, revogacao, data/hora, finalidade e versao dos termos.
...
## Criterios de aceite
- [ ] Usuario pode revogar consentimento.
- [ ] Sistema respeita consentimento antes de chamar IA/integracoes.
