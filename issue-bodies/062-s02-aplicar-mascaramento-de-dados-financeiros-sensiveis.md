# Aplicar mascaramento de dados financeiros sensiveis
...
## Objetivo
Reduzir exposicao de dados como conta, cartao, identificadores e mensagens brutas.

## Escopo
Mascarar na UI, logs, erros e eventos; preservar dados necessarios para conciliacao.
...
## Criterios de aceite
- [ ] Logs nao exibem numero completo de conta/cartao.
