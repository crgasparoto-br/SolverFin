# Criar politica de retencao, exportacao e exclusao de dados
...
## Objetivo
Documentar direitos do usuario e operacao de dados.

## Escopo
Definir exportacao, exclusao, retencao de logs, backups, anexos e mensagens brutas.
...
## Criterios de aceite
- [ ] Documento gera backlog tecnico claro para implementacao.
