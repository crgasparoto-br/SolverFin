# Implementar exclusao logica e trilha de auditoria segura
...
## Objetivo
Evitar perda acidental e preservar rastreabilidade.

## Escopo
Soft delete para entidades financeiras, auditoria de exclusoes e restricao de hard delete.
...
## Criterios de aceite
- [ ] Itens excluidos nao aparecem por padrao, mas permanecem auditaveis.
