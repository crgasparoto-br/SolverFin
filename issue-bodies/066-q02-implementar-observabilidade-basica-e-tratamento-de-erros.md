# Implementar observabilidade basica e tratamento de erros

**Parent epic:** `E11` - [EPIC] Qualidade, observabilidade e operacao
**Fase:** MVP
...
## Objetivo
Facilitar diagnostico por humanos e IA.

## Escopo
Logs estruturados, correlation id, pagina de erro, API errors padronizados e boundary no frontend.
...
## Criterios de aceite
- [ ] Erro de API retorna codigo e mensagem controlada.
- [ ] Logs incluem correlation id sem dados sensiveis.
