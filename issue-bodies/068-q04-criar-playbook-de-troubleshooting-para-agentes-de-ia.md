# Criar playbook de troubleshooting para agentes de IA
...
## Objetivo
Ajudar agentes a corrigirem falhas comuns de build, teste e ambiente.

## Escopo
Documentar erros comuns, comandos de limpeza, reset de banco, migrations e CI.
...
## Criterios de aceite
- [ ] Playbook resolve os principais erros esperados do setup.
