# Definir contrato de integracao com Limite MEI

**Parent epic:** `E12` - [EPIC] Integracoes SolverIT e plano profissional/MEI
**Fase:** MVP
...
## Objetivo
Planejar como receitas do SolverFin alimentam controle do limite MEI.

## Escopo
Mapear receitas MEI, competencias, cancelamentos, ajustes, exportacao e reconciliacao.

## Fora de escopo
Nao cobrir funcionalidades fora do escopo descrito; nao antecipar integracoes externas sem ADR aprovada.

## Artefatos esperados
- `docs/integrations/limite-mei.md`

## Criterios de aceite
- [ ] Documento define quais receitas entram no calculo do MEI.
