...
A edição ampliada é sempre relativa à ocorrência selecionada. Quando houver \\`Installment\`, a posição é determinada por \\`sequenceNumber\`; o critério por data é usado apenas para dados legados sem parcela vinculada.
