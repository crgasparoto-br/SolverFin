...
const keyScenarios = [
  {
    ...
    coverage: [
      coverage({ route: "/lancamentos", archetype: "A2", state: "normal", layout: "desktop-mobile", interaction: "overflow-and-focus", dataProfile: "long-statement" }),
      coverage({ route: "/dashboard", archetype: "A1", state: "normal", layout: "desktop-mobile", interaction: "viewport-smoke", dataProfile: "demo-seed" }),
      coverage({ route: "/cartoes", archetype: "A3", state: "normal", layout: "desktop-mobile", interaction: "viewport-smoke", dataProfile: "demo-seed" }),
      coverage({ route: "/contas", archetype: "support", state: "normal", layout: "desktop-mobile", interaction: "viewport-smoke", dataProfile: "demo-seed" }),
    ],
  },
  {
    ...
    coverage: [
      coverage({ route: "/relatorios", archetype: "A5", state: "normal", layout: "desktop-mobile", interaction: "keyboard-focus-overflow", dataProfile: "category-evolution" }),
      coverage({ route: "/relatorios", archetype: "A5", state: "empty", layout: "desktop", interaction: "state-render", dataProfile: "future-period" }),
      coverage({ route: "/relatorios", archetype: "A5", state: "error", layout: "desktop", interaction: "filter-error", dataProfile: "invalid-filter" }),
    ],
  },
  {
    id: "ui-primitives",
    ...
    coverage: [
      coverage({
        ...
        components: ["PageContainer", "PageHeader", "DataTable", "DetailLayout", "Dialog", "Drawer"],
      }),
    ],
  },
  {
    ...
    coverage: [
      coverage({
        ...
        components: ["FilterBar", "SummaryGrid", "FormLayout", "EmptyState", "Loading", "RecoverableError", "UnavailableState", "PermissionState", "Tabs", "Badge", "Alert", "Toast"],
  ...
  },
  {
    ...
    coverage: [
      coverage({ route: "/cartoes", archetype: "A3", state: "normal", layout: "desktop-mobile", interaction: "filters-modal", dataProfile: "invoice-purchases" }),
      coverage({ route: "/cartoes", archetype: "A3", state: "empty", layout: "desktop", interaction: "filtered-empty", dataProfile: "no-search-results" }),
    ],
  },
];
