...
function simpleScenario(
  ...
  return {
    ...
    module,
    coverage: [
      coverage({ route, archetype, audience, state, layout, interaction, dataProfile }),
    ],
  };
}
...
const simpleScenarios = [
  ...
  ["secondary-admin-institutions", "scripts/statement-visual/issue-615-secondary-route.mjs", "/admin/instituicoes", "admin-maintenance", "normal", "desktop-mobile", "keyboard-focus-overflow", "master-institutions", "master"],
  ["secondary-admin-financial-indexes", "scripts/statement-visual/issue-615-secondary-route.mjs", "/admin/indices-financeiros", "admin-operations", "normal", "desktop-mobile", "keyboard-focus-overflow", "master-financial-indexes", "master"],
  ["secondary-account-remuneration-legacy", "scripts/statement-visual/issue-615-secondary-route.mjs", "/remuneracao-contas", "legacy-compatibility", "compatibility-renderer", "desktop-mobile", "keyboard-focus-overflow", "legacy-remuneration-renderer", "financial-profile"],
