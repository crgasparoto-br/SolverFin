...
if (!chromePath) throw new Error("CHROME_BIN is required for transaction group pending fixes validation.");
...
try {
  ...
  assert.equal(cloneDescription.length, 240, "Clone description was not limited to 240 characters.");
